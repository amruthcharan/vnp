...
@section('title')
    <title>Vet N Pet - Update Vaccination</title>
@endsection
@section('breadcrum')
    <!-- ============================================================== -->
...
@section('content')
    <div class="row" style="margin: 0 auto">
        ...
        <div class="col-md-6"  style="margin: 0 auto">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title" style="text-align: center">Edit Vaccination</h4>
                    @include('includes.formerror')
                    {!! Form::open(['method'=>'PATCH', 'action' => ['VaccinationController@update',$vaccination->id]]) !!}
                    <div class="form-group">
                        {!! Form::label('patient_id', '* Patient:') !!}
                        {!! Form::text('patient_id', $vaccination->patient->id , ['class'=>'form-control pat_id', 'readonly'=>'readonly']) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('vaccine_id', '* Vaccine:') !!}
                        {!! Form::select('vaccine_id', $vaccines , $vaccination->vaccine_id , ['class'=>'form-control select22']) !!}
                    </div>
                    <div class="form-group">
