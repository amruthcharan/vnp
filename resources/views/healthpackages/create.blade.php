...
@section('title')
    <title>Vet N Pet - New Health Package</title>
@endsection
@section('breadcrum')
    <!-- ============================================================== -->
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Add New Health Package</h4>
...
@section('content')
    <div class="row" style="margin: 0 auto">
        ...
        <div class="col-md-6"  style="margin: 0 auto">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title" style="text-align: center">New Health Package</h4>
                    @include('includes.formerror')
                    {!! Form::open(['method'=>'POST', 'action' => 'HealthPackageController@store']) !!}
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('package_id', $packages , null , ['class'=>'form-control select22']) !!}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="border-top">
                            <div class="card-body">
                                {!! Form::submit('Add Package', ['class'=>'btn btn-primary btn-block gensymp']) !!}
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
